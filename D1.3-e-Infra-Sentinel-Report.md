...
In this document, we provide some insight into the state of play of e-Infrastructures in the regions covered by Sci-GaIA, some outlook on possible paths of development in the near future, and some recommendations to various actors in the ecosystem.
We consider both digital infrastructures (communication networks, data infrastructures, compute and cloud infrastructures, _etc_) and aspects of the commons.
...
We generally aim to follow the structure of the e-Infrastructures Reflection Group
