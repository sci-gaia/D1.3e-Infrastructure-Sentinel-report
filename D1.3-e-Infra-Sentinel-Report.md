...
references:
  ...
  - id: Shave:2152388
    ...
    - year: '2016'
      month: May
    title: <span class="nocase">Distribution of all CERN Users by Nationality on 12
      January 2016</span>
    note: General Photo
...
As an example although there are no synchrotron light sources on the African continent, the field of paleontology,  which relies heavily on these instruments to analyse samples [@cunningham_virtual_2014], has produced leading scientific results by African authors^[It should be noted, though, that this research is not _published_ in African journals.] [@berger2010australopithecus].
...
We generally aim to follow the structure of the e-Infrastructures Reflection Group (e-IRG) 2016 Roadmap [@eirg_roadmap_2016], looking at network, computing, data and clouds
