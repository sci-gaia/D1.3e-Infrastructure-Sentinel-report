...
- [Introduction](#introduction)
	- [Scope](#scope)
	- [The need for an e-Infrastructure Sentinel](#the-need-for-an-e-infrastructure-sentinel)
	- [Actions taken by Sci-GaIA to promote interoperability](#actions-taken-by-sci-gaia-to-promote-interoperability)
		- [Interoperability with European infrastructures](#interoperability-with-european-infrastructures)
		- [Improving context and exposure in future infrastructures](#improving-context-and-exposure-in-future-infrastructures)
		- [Technical workshops on Open Infrastructure](#technical-workshops-on-open-infrastructure)
- [The General e-Infrastructure landscape](#the-general-e-infrastructure-landscape)
	- [Networking](#networking)
		- [Science DMZs](#science-dmzs)
	- [Computing infrastructures](#computing-infrastructures)
	- [Data Infrastructures](#data-infrastructures)
	- [Clouds](#clouds)
- [The e-Infrastructure Commons](#the-e-infrastructure-commons)
	- [Identity and security services](#identity-and-security-services)
	- [FAIR data services](#fair-data-services)
	- [Training and Skills](#training-and-skills)
...
However, functioning e-Infrastructure exists in a _context_, including both the physical resources themselves, as well as the _configuration_ and _orchestration_ of those resources at a site.
...
However, few national libraries or archives are ready to perform their role as custodian of national _data_, as they have been doing for other forms of information.
...
We have noted the development, since last surveyed, of two mature clouds for research, in South Africa and Nigeria.
...
All research depends on infrastructure of some sort - be it a university, a funding environment, a power grid, _etc_.
...
Many new or maturing services such as persistence and uniqueness identifiers for data and people, identity federations and advanced network services are becoming so widely used that it no longer makes sense to own and operate them privately.
...
Many of the challenges that we foresee in maintaining a viable ecosystem for African e-Infrastructure comes down to simply making funds available and have been better documented elsewhere.
